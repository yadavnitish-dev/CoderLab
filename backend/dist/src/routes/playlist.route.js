...
router.post("/create-playlist", authMiddleware, generalLimiter, sanitizeInputs, createPlayList);
router.post("/:playlistId/add-problem", authMiddleware, generalLimiter, sanitizeInputs, addProblemToPlaylist);
router.delete("/:playlistId", authMiddleware, generalLimiter, deletePlayList);
router.delete("/:playlistId/remove-problem", authMiddleware, generalLimiter, sanitizeInputs, removeProblemFromPlaylist);
