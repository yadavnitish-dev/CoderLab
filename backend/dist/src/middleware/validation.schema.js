...
export const createProblemSchema = z.object({
    ...
    referenceSolutions: z
        ...
        .refine((obj) => Object.keys(obj).length > 0, "At least one reference solution required"),
});
...
export const executeCodeSchemaWithValidation = executeCodeSchema.refine((data) => data.stdin.length === data.expected_outputs.length, {
