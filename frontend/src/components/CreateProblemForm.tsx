...
const CreateProblemForm = () => {
  ...
  const loadSampleData = () => {
    ...
    const sampleData = sampleDataMap[
      sampleType as keyof typeof sampleDataMap
    ] as any;
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 pb-6 border-b border-white/5 gap-4">
              ...
              <div className="flex flex-wrap gap-3">
                <div className="join bg-black border border-zinc-800 rounded-sm p-1">
                  <button
                    type="button"
                    className={`btn btn-sm border-0 rounded-sm ${
                      sampleType === "DP"
                        ? "bg-white text-black shadow-lg"
                        : "btn-ghost hover:bg-zinc-900"
                    }`}
                ...
                <button
                  type="button"
                  className="btn btn-sm btn-ghost border border-zinc-800 hover:bg-zinc-900 gap-2 rounded-sm"
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="form-control">
                  ...
                  <select
                    className={`select select-bordered w-full bg-black border-zinc-800 focus:border-emerald-500/50 transition-all rounded-sm ${errors.difficulty ? "select-error" : ""}`}
                    {...register("difficulty")}
                  >
